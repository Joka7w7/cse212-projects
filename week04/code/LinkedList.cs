...
public class LinkedList : IEnumerable<int>
{
    ...
    public void Remove(int value)
    {
        ...
        while (curr is not null)
        {
            if (curr.Data == value)
            {
                ...
                // Otherwise, it's somewhere in the middle, so reconnect
                // the neighbors to skip over 'curr'.
                else
                {
    ...
    {
        // Walk the entire list, replacing every matching value.
        Node? curr = _head;
        while (curr is not null)
        {
            ...
            curr = curr.Next; // Keep going to find all matches
        }
    }
